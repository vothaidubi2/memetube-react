...
export default function CommentManage() {
    ...
    const handleShowComment = async () => {
        setIdvideoComment(param.get('idvideo'));
        const currentVideo = await VideoAPI.getOneItem(`/getonevideo?id=${param.get('idvideo')}`)
        const listComment = await CommentAPI.getAllBaseCmt(`/getallbasecmt?idvideo=${param.get('idvideo')}`)
